(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('roslib'), require('urdf-loader'), require('stats-js'), require('@juggle/resize-observer'), require('three/examples/jsm/controls/EditorControls')) :
  typeof define === 'function' && define.amd ? define(['three', 'roslib', 'urdf-loader', 'stats-js', '@juggle/resize-observer', 'three/examples/jsm/controls/EditorControls'], factory) :
  (global = global || self, global.amphion = factory(global.THREE, global.ROSLIB, global.URDFLoader, global.Stats, global.resizeObserver, global.THREE));
}(this, function (THREE, ROSLIB, URDFLoader, Stats, resizeObserver, EditorControls) { 'use strict';

  ROSLIB = ROSLIB && ROSLIB.hasOwnProperty('default') ? ROSLIB['default'] : ROSLIB;
  ...
  ** */
  ...
  class Viewer3d {
    ...
    setContainer(domNode) {
      this.container = domNode;
      this.initRenderer(domNode);
      this.controls = new EditorControls.EditorControls(this.camera, this.container);
      this.controls.enableDamping = true;
